...
export const ThreeProblemsSection = () => {
  return (
    <section className="relative overflow-hidden bg-background px-4 py-12 sm:px-6 md:py-16">
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <strong className="text-foreground/80">Streamline everything</strong>{" "}
          with a dedicated partner.
        </motion.p>

        <div className="mb-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 sm:gap-5">
          {problems.map((p, i) => (
            <motion.div
              key={i}
              {...stagger(i)}
            ...
            >
              ...
              <p className="mb-5 flex-1 text-sm leading-relaxed text-foreground/55 sm:mb-6">
                {p.desc}
              </p>
              <button
                type="button"
                ...
                style={{ color: p.ctaColor, border: `1px solid ${p.ctaColor}` }}
              >
                {p.cta}
              </button>
            </motion.div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="mb-1 font-dela text-base text-foreground sm:text-lg">
                Let Us Solve These Problems For You
              </h4>
              <p className="text-sm leading-relaxed text-foreground/55">
                Streamline your pickleball events with one dedicated partner for
          ...
          <Button
            variant="lime"
            size="lg"
            className="group h-11 bg-lime shrink-0 rounded-full px-6 text-sm font-bold sm:h-12"
            onClick={() =>
              document
                .getElementById("final-cta")
                ?.scrollIntoView({ behavior: "smooth" })
        ...
        <motion.div
          {...fadeUp}
          className=" flex gap-10 flex-col lg:flex-row items-start"
        >
          <div className="flex flex-col items-start">
            <h3 className="font-dela text-[1.8rem]/[1.1] text-foreground sm:text-3xl md:text-4xl">
              This Isn't Just Stressful.
            </h3>
            <h3 className="mb-5 text-center font-dela text-[1.8rem]/[1.1] text-primary sm:mb-6 sm:text-3xl md:text-4xl">
              It's Costing You.
            </h3>

            <p className="mx-auto mb-5 max-w-xl text-sm leading-relaxed text-foreground/55 sm:mb-8 sm:text-base">
              India's pickleball market is at an inflection point. The
              associations and organisers who establish a credible brand now
              will define the sport for the next decade.
            </p>
            ...
            <div className="">
              <Button
                variant="lime"
                size="lg"
                className="group bg-limes h-11 rounded-full px-8 text-sm font-bold sm:h-12 sm:px-10 sm:text-base"
                onClick={() =>
                  document
                    .getElementById("final-cta")
                    ?.scrollIntoView({ behavior: "smooth" })
          ...
          >
            ...
            <div className="flex items-start gap-3 rounded-xl bg-primary/10 p-4">
              ...
              <span className="text-sm text-foreground sm:text-base">
                You don't need more vendors. You need a partner who already
                lives inside pickleball.
              </span>
            </div>
          </div>
        </motion.div>
